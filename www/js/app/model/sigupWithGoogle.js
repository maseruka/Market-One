...
var signupWithGoogle ={
  authorize: function(options) {
    ...
    callGoogle:function() { console.log("hello google");
       googleapi.authorize({
        client_id: '848941753580-2hbqvicam40ei8luf2h22dojvkfjrrtt.apps.googleusercontent.com',
        client_secret: '9k70GiQpL113_BAehMGu4MW6',
        ...
        signupWithGoogle.getDataProfile();

    });
    console.log("hello google and pie");
    },
    ...
    $.ajax({
       ...
       signupWithGoogle.disconnectUser();
    },
